...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('LEF1e-yyR1', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cdE6UqIMqo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('BPTEqOjBOa6rt2M1kV0wp82H5NkeL8o0njaLDD44JXEYCyORhZHLVdg3x0gPAZWA'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                54 => 'ets_megamenu',
                55 => 'ets_multilayerslider',
                56 => 'ybc_widget',
                57 => 'ybc_themeconfig',
                58 => 'ybc_specificprices',
                59 => 'ybc_productimagehover',
            ],
            ...
            'modules_translation_paths' => [
                ...
                28 => (\dirname(__DIR__, 4).'/modules/ybc_blog_free/translations'),
                ...
                39 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                ...
                51 => (\dirname(__DIR__, 4).'/modules/ets_multilayerslider/translations'),
            ],
            ...
            'kernel.secret' => 'BPTEqOjBOa6rt2M1kV0wp82H5NkeL8o0njaLDD44JXEYCyORhZHLVdg3x0gPAZWA',
